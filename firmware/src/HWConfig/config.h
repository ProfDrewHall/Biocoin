...
#define BIOCOIN_FW_VERSION "1.1.4" // Keep in sync with release tags/app compatibility.
...
namespace bluetooth {
  ...
  constexpr uint8_t kUUIDChrDigitalConfig[] = {0xAA, 0x93, 0xBC, 0xEA, 0x5F, 0x78, 0x23, 0x15,
                                               0xDE, 0xEF, 0x12, 0x12, 0x2B, 0x15, 0x00, 0x00};

  constexpr uint8_t kUUIDChrDigitalValue[] = {0xAA, 0x93, 0xBC, 0xEA, 0x5F, 0x78, 0x23, 0x15,
